...
namespace TravelPlanning.Components.Account
{
    ...
    internal sealed class IdentityNoOpEmailSender : IEmailSender<TravelPlanningUser>
    {
        private readonly IEmailSender emailSender = new NoOpEmailSender();

        public Task SendConfirmationLinkAsync(TravelPlanningUser user, string email, string confirmationLink) =>
