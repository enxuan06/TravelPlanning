...
namespace TravelPlanning.Migrations
{
    ...
    [Migration("20241202080501_SeedData")]
            ...
            modelBuilder.Entity("TravelPlanning.Domain.Accommmodation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "System",
                            DataUpdated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(3948),
                            DateCreated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(3935),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "System",
                            DataUpdated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(3952),
                            DateCreated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(3951),
            ...
            modelBuilder.Entity("TravelPlanning.Domain.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = "System",
                            DataUpdated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(4275),
                            DateCreated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(4275),
                            Duration = 1,
                            Location = "Bugis",
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = "System",
                            DataUpdated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(4279),
                            DateCreated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(4278),
                            Duration = 2,
                            Location = "Juhor",
            ...
            modelBuilder.Entity("TravelPlanning.Domain.Transportation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 150.50m,
                            CreatedBy = "System",
                            DataUpdated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(4358),
                            DateCreated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(4357),
                            EndLocation = "Bugis",
                        ...
                        new
                        {
                            ...
                            Cost = 60.50m,
                            CreatedBy = "System",
                            DataUpdated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(4361),
                            DateCreated = new DateTime(2024, 12, 2, 16, 5, 1, 178, DateTimeKind.Local).AddTicks(4360),
                            EndLocation = "Juhor",
